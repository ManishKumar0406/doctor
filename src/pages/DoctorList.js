...
function DoctorList() {
    ...
    useEffect(() => {
        if ((!ReactSession.get("token_id") || !ReactSession.get("user_id"))) {
        ...
        else if(ReactSession.get("usertype")=="Patient"){
            const requestOptions = { token_id: ReactSession.get("token_id"), user_id: ReactSession.get("user_id")};
            axios.post('http://react.virtupaper.co.in/api/v1/patient/doctor-list', requestOptions)
                .then(response => {
            ...
            const requestOptions = { token_id: ReactSession.get("token_id"), user_id: ReactSession.get("user_id"),usertype:"Doctor"};
        ...
        <div style={{ backgroundColor: "#f2f6fc", color: "#69707a" }}>
            ...
            <div className="row">
                ...
                <div className="row">
                    ...
                    <div className="col-8">
                        <div className="card-header" style={styleHeader}><b>Doctor's List</b></div>
