                ...
                <div className="row">
                    ...
                    <div className="col-8">
                        <div className="card mb-4">
                            <div className="card-header" style={styleHeader}><b>Edit Details of {profileData.usertype} </b></div>
                            <div className="card-body" style={{ fontSize: "16px" }}>
                                <div className="mb-3 row  gx-3">
                                    <div className="form-group">
                                        <label className="small mb-1 form-label" htmlFor="Name">Name</label>
                                        <input className="form-control" id="Name" type="text" name="name"
                                            placeholder="Enter your username" value={name} onChange={handleChange} />
                                    </div>
                                </div>
                                ...
                                <div className="row gx-3 mb-3">
                                    ...
                                    <div className="col-6 form-group">
                                        ...
                                        <input readOnly className="form-control" id="mobile" type="tel"
                                            placeholder="Enter your phone number" value={profileData.mobile} />
                                    </div>
                                </div>
                                <div className="row gx-3 mb-3">
                                    <div className="col-6 form-group">
                                ...
                                <div className="row">
                                    <div className="col-5">
                                        <div className="row">
                                            ...
                                            < div className="col-6">
                                                <Link to="/profile"><button className="btn btn-success" type="button"><b>Back</b>
                                                </button></Link>
                                            </div>
                                        </div>
                                    </div>
